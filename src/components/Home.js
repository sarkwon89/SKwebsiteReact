...
function Home() {
    ...
    <div className="container">
      <div id="aboutmesection" className="row">
        <div className="col s12 ">
          ...
          <div className="aboutmeheader2">
            ...
            <p>4 yrs, 5 mos</p>
            <div id="search">
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/itBUJNP9XWA?start=41"
            ...
            <p> Full-stack development
              <br />
              3 mos </p>
            <h5>School of Visual Concepts</h5>
            <p>Fundamentals of UX<br />3 mos</p>

            <h5>Seattle Pacific University</h5>
        ...
        <div className="row">
          <div className="col s12 m6">
            ...
            <p>This was the first product I launched as a product manager in 2017. Raven is an inline
              auto-play
              video unit on the main home, name and title pages on IMDb app plus desktop. Raven was the
              first
              to
          ...
          <div className="col s12 m6">
            ...
            <p>IMDb served pop up display ads until 2017. As the product manager, moved pop up ads inline on
              the
              most trafficked page types on IMDb mobile app in 2018 with plans to move programmatic ads
              inline
              by
        ...
        <div className="row">
          <div className="col s12">
            ...
            <p>Created and launched Pilot, which is a program that drives incremental short-term and long-term
              revenue by experimenting and prototyping in a fast-paced environment. One of the experiments we
      ...
      <div id="projectsection" className="row projects">
        ...
        <div class="row">
          <div class="col s12 m6">
            <hr />
            <h4>Tender</h4>
            <p>Built a web application that will generate cocktail recommendations for the user using two
              server-side APIs, a third party CSS and Javascript
              framework. This was a group project with 3 people and had 3 days to deliver the application.</p>
            <a href="https://github.com/chrisp-dev/drinkanator" target="_blank">
        ...
        <div class="row">
          ...
          <div class="col s12 m6">
            ...
            <p>Customer </p>
            <a href="https://github.com/sarkwon89/SKnotetaker" target="_blank">
              <i class="fab fa-github-alt fa-2x"></i>
            </a>
        ...
        <div class="row">
          <div class="col s12 m6">
            ...
            <p>Built an employee management system also known as a CMS. Developers are often tasked with
              creating
              interfaces that make it easy for non-developers to view and interact with information stored in
              databases.</p>
          ...
          <div class="col s12 m6">
            ...
            <p>Built a web application that allows a user to view or share recommendations to help people
              discover new products and experiences. Built this application using materialize (css framework),
              cloudinary (server-side API), and MySQL with sequelize ORM. This was a group project with 4
              people and had 5 days to deliver the application.
            </p>
            <a href="https://github.com/sarkwon89/Top3recs" target="_blank">
              <i class="fab fa-github-alt fa-2x"></i>
            </a>
      ...
      <div id="commericalsection" class="row commercial">
        <div class="col s12">
          <hr />
          <h2>COMMERCIAL</h2>
          <p>Outside of my career, I've had the privilege to work with The Distillery and Dell EMC the
            past 3
            years by being a talent for their commercials. Through this experience I have learned what
            it takes
            to create video content in a fast pace environmnet.</p>
        </div>
        <div class="row">
          <div class="col s12 m6">
            <hr />
            <h4>DELL EMC Unity XT</h4>
            <p>Played a round of charades to uncover DELL EMC's awesome product
              called Unity XT.</p>
            <div id="search">
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/B5IWyUgUDI0" frameborder="0"
          ...
          <div class="col s12 m6">
            <hr />
            <h4>DELL EMC PowerOne</h4>
            <p>Thanks to Dell EMC Power One, you can have time for more enlightened
              things like finding your chi. &#129496 </p>
            <div id="search">
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/jvdRI9oSFF8" frameborder="0"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col s12 m6">
            <hr />
            <h4>DELL EMC Cloud</h4>
            <p>Dell EMC Cloud Marketplace – Now Open
            </p>
            <div id="search">
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/XCaFh6ezx8I?start=12"
                frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
            </div>
          </div>
          <div class="col s12 m6">
            <hr />
            <h4>Dell EMC IDPA</h4>
            <p>Complete backup, replication, recovery, deduplication, instant access and restore — all in a
              single appliance.</p>
            <div id="search">
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/JMKAH9URQUc?start=14"
                frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
            </div>
          </div>
